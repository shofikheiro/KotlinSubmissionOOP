 ...
 */
fun myProfile() {
    val firstName: String = "Shofiyya"
    val lastName: String = "Kheista"
    val age: Int = 21
 ...
 */
fun myTeam(): List<Any> {
    val groupMembers = listOf("Shofiyya", "Farida", "Fadillah", "Astriani", "Taufiq")
...
fun totalMember(): Int {
    ...
    val countOfGroup = arrayOf<String>("Shofiyya", "Farida", "Fadillah", "Astriani", "Taufiq")
...
fun main() {
     ...
     *
     */
    groupDetail("Strix", listOf("Shofiyya", "Farida", "Fadillah", "Astriani", "Taufiq"), "Afternoon")
